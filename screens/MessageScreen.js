...
export default class MessageScreen extends React.Component {
  ...
  componentDidMount() {
    ...
    this.socket = io('http://192.168.1.49:3000/');
    // this.socket.emit('userOnline', this.state.name);
    // this.socket.on('userOnline', (name) => {
    //   this.setState({ListUser: [...this.state.ListUser, name]});
    // });
